...
import { Card, CardHeader, Table, Container, Row, CardBody } from "reactstrap";
        ...
        <Row>
          <div className="col">
            <Card className="shadow">
              ...
              {loading ? 
                <>
                  <img src={require("../../assets/img/loading.gif")} alt="GIF carregando" style={{    
                    width: "250px",
                    alignSelf: "center"
                  }} /> <p style={{    
                    alignSelf: "center"
                  }}>Buscando Informações </p> <br /> 
                </> : 
